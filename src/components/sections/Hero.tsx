    ...
    <section className="py-16 pb-12">
      <div className="max-w-[1120px] mx-auto px-7 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="relative order-first lg:order-last">
          ...
          <div className="hidden sm:flex absolute top-6 -right-4 max-lg:right-2 bg-white rounded-md shadow-lg border border-border-light px-4 py-3 items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-accent-green-bg flex items-center justify-center">
              <Check size={16} className="text-accent-green" />
            </div>
            <div>
              <p className="text-xs font-semibold text-foreground">Compare 20+ insurers</p>
              <p className="text-[0.7rem] text-foreground-muted">100s from $18/mo</p>
            </div>
          </div>

          {/* Floating Card - Bottom Left */}
          <div className="hidden sm:block absolute bottom-6 -left-4 max-lg:left-2 bg-white rounded-md shadow-lg border border-border-light px-4 py-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[0.7rem] text-foreground-muted">Canadians</span>
            </div>
            <div className="flex items-center gap-1.5 text-[0.72rem] text-foreground-muted">
